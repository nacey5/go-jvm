...
import (
	...
	"go-jvm/ch06/instructions/comparisons"
	"go-jvm/ch06/instructions/constants"
	"go-jvm/ch06/instructions/control"
	"go-jvm/ch06/instructions/conversions"
	"go-jvm/ch06/instructions/extended"
	"go-jvm/ch06/instructions/loads"
	"go-jvm/ch06/instructions/math"
	"go-jvm/ch06/instructions/references"
	"go-jvm/ch06/instructions/stack"
