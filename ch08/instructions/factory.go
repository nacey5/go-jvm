...
import (
	...
	"go-jvm/ch08/instructions/comparisons"
	"go-jvm/ch08/instructions/constants"
	"go-jvm/ch08/instructions/control"
	"go-jvm/ch08/instructions/conversions"
	"go-jvm/ch08/instructions/extended"
	"go-jvm/ch08/instructions/loads"
	"go-jvm/ch08/instructions/math"
	"go-jvm/ch08/instructions/references"
	"go-jvm/ch08/instructions/stack"
