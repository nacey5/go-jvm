...
func (self *LDC) Execute(frame *runtime_data_area.Frame) {
...
func (self *LDC_W) Execute(frame *runtime_data_area.Frame) {
	_ldc(frame, self.Index)
}
...
func (self *LDC2_W) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
