...
func (self *RETURN) Execute(frame *runtime_data_area.Frame) {
...
func (self *ARETURN) Execute(frame *runtime_data_area.Frame) {
	thread := frame.Thread()
...
func (self *DRETURN) Execute(frame *runtime_data_area.Frame) {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
...
func (self *FRETURN) Execute(frame *runtime_data_area.Frame) {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
...
func (self *IRETURN) Execute(frame *runtime_data_area.Frame) {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
...
func (self *LRETURN) Execute(frame *runtime_data_area.Frame) {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
