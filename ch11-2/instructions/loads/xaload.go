...
func (self *AALOAD) Execute(frame *runtime_data_area.Frame) {
...
func (self *BALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *CALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *DALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *FALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *IALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *LALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *SALOAD) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
