...
func (self *AASTORE) Execute(frame *runtime_data_area.Frame) {
...
func (self *BASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopInt()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *CASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopInt()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *DASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopDouble()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *FASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopFloat()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *IASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopInt()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *LASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopLong()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *SASTORE) Execute(frame *runtime_data_area.Frame) {
	stack := frame.OperandStack()
	val := stack.PopInt()
	index := stack.PopInt()
	arrRef := stack.PopRef()
