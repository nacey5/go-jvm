...
func _unsafe(method func(frame *runtime_data_area.Frame), name, desc string) {
	native.Register("sun/misc/Unsafe", name, desc, method)
}

// public native long allocateMemory(long bytes);
// (J)J
func allocateMemory(frame *runtime_data_area.Frame) {
...
// (JJ)J
func reallocateMemory(frame *runtime_data_area.Frame) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
...
// (J)V
func freeMemory(frame *runtime_data_area.Frame) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
	free(address)
...
// // (JJ)V
//
//	func putAddress(frame *runtime_data_area.Frame) {
//		mem_putLong(frame)
//	}
//
...
// // (J)J
//
//	func getAddress(frame *runtime_data_area.Frame) {
//		mem_getLong(frame)
//	}
//
...
// // (JB)V
//
//	func mem_putByte(frame *runtime_data_area.Frame) {
...
// (J)B
func mem_getByte(frame *runtime_data_area.Frame) {
...
// // (JS)V
//
//	func mem_putShort(frame *runtime_data_area.Frame) {
//		mem, value := _put(frame)
...
// // (J)S
//
//	func mem_getShort(frame *runtime_data_area.Frame) {
//		stack, mem := _get(frame)
...
// // (JC)V
//
//	func mem_putChar(frame *runtime_data_area.Frame) {
//		mem, value := _put(frame)
...
// // (J)C
//
//	func mem_getChar(frame *runtime_data_area.Frame) {
//		stack, mem := _get(frame)
...
// // (JI)V
//
//	func mem_putInt(frame *runtime_data_area.Frame) {
//		mem, value := _put(frame)
...
// // (J)I
//
//	func mem_getInt(frame *runtime_data_area.Frame) {
//		stack, mem := _get(frame)
...
// (JJ)V
func mem_putLong(frame *runtime_data_area.Frame) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
...
// // (J)J
//
//	func mem_getLong(frame *runtime_data_area.Frame) {
//		stack, mem := _get(frame)
...
// // (JJ)V
//
//	func mem_putFloat(frame *runtime_data_area.Frame) {
//		mem, value := _put(frame)
...
// // (J)J
//
//	func mem_getFloat(frame *runtime_data_area.Frame) {
//		stack, mem := _get(frame)
...
// // (JJ)V
//
//	func mem_putDouble(frame *runtime_data_area.Frame) {
//		mem, value := _put(frame)
...
// // (J)J
//
//	func mem_getDouble(frame *runtime_data_area.Frame) {
//		stack, mem := _get(frame)
//		stack.PushDouble(Float64(mem))
//	}
//
//	func _put(frame *runtime_data_area.Frame) ([]byte, interface{}) {
//		vars := frame.LocalVars()
//		// vars.GetRef(0) // this
//		address := vars.GetLong(1)
//		value := vars.Get(3)
...
//		return mem, value
//	}
func _get(frame *runtime_data_area.Frame) (*runtime_data_area.OperandStack, []byte) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
