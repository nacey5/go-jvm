...
func newInstance0(frame *runtime_data_area.Frame) {
	...
	shimFrame := runtime_data_area.NewShimFrame(frame.Thread(), ops)
...
// Object[] -> []interface{}
func convertArgs(this, argArr *heap.Object, method *heap.Method) *runtime_data_area.OperandStack {
	...
	ops := runtime_data_area.NewOperandStack(method.ArgSlotCount())
	if !method.IsStatic() {
		ops.PushRef(this)
	}
